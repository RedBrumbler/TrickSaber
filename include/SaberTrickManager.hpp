...
DECLARE_CLASS_CODEGEN(TrickSaber, LeftSaberTrickManager, TrickSaber::SaberTrickManager,
    DECLARE_DEFAULT_CTOR();
)

DECLARE_CLASS_CODEGEN(TrickSaber, RightSaberTrickManager, TrickSaber::SaberTrickManager,
    DECLARE_DEFAULT_CTOR();
)
