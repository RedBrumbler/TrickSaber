...
DECLARE_CLASS_CODEGEN(TrickSaber, SaberTrickModel, Il2CppObject,
    ...
    DECLARE_INJECT_FIELD_OPTIONAL(GlobalNamespace::MultiplayerPlayersManager*, _multiplayerPlayersManager);
    DECLARE_INJECT_METHOD(void, Inject, Lapiz::Sabers::LapizSaberFactory* lapizSaberFactory, GlobalNamespace::ColorManager* colorManager);
